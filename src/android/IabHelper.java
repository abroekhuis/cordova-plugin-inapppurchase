...
public class IabHelper {
    ...
    public void launchSubscriptionPurchaseFlow(Activity act, String sku, int requestCode,
            OnIabPurchaseFinishedListener listener, String extraData, List<String> oldSkus)
        throws IabAsyncInProgressException {
        launchPurchaseFlow(act, sku, ITEM_TYPE_SUBS, oldSkus, requestCode, listener, extraData);
    }
